      ...
      <div className="relative container md:w-2/3 mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-opacity-80 bg-slate-50 shadow-lg p-5 rounded-lg items-center border-secondary-1">
          ...
          <div className="order-5 md:order-5 md:col-span-2">
            <h3 className="text-lg text-emerald-800 mb-2 text-center">A Shared Memory</h3>
            <p className="text-sm font-body2 font-medium leading-relaxed text-justify text-gray-600">
              Looking back, our first date was a blend of excitement, nerves, and the kind of small challenges 
              that now make for a good story. From matching sling bags to concealed blisters and the comfort of 
              speaking our native tongue, it was a day filled with the kind of genuine moments that lay the 
              foundation for something truly special.
            </p>
          </div>
        </div>
      </div>
