...
import vespaGif from '../assets/vespaA.gif'
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center px-4">
        ...
        <img src={vespaGif} alt="vespa" className="h-48 mx-auto" />
        ...
        <div className="p-8 rounded-lg shadow-lg border-t-4 border-emerald-500 animate-fadeInUp">
          ...
          <p className="text-lg font-body2 text-gray-600 mb-2">Saturday, May 17, 2025</p>
          <p className="text-md font-body2 text-gray-600">Ceremony at 3:30 PM</p>
          <p className="text-md font-body2 text-gray-600">Reception to follow at 5:00 PM</p>
        </div>
      </div>
    </section>
  );
